...
namespace Dodecahedroid
{
	public class Dodecahedron
	{
		...
		public void Render ()
		{
			...
			GL.Uniform3 (uniforms [UNIFORM_LIGHT], 0f, 0f, -100f); //originally 25,25,28
		...
		internal void DrawModel ()
		{
            ...
            GL.VertexAttribPointer (ATTRIB_TEXCOORD, 2, VertexAttribPointerType.Float, false, sizeof(float)*8, new IntPtr (sizeof (float)*6));
